...
var leftButton = document.querySelector(".slider__btn-left");
var rightButton = document.querySelector(".slider__btn-right");
var dots = document.querySelectorAll(".dots__item");
var index = 0;
var startX = null;
var startY = null; // Slider function
...
sliderBlock.addEventListener("touchmove", handleTouchMove, false); // Interval Slider

setInterval(nextSlide, 8000); // Swipe Slider
